...
By configuring the PCE you will feed the PCE all the information necessary to comply wiht this legal requirement. The same information will be used across the other components of the DevKit (e.g. [interfaces](/docs/interfaces)) to deliver compliance in action.

Make sure to provide the PCE with all
