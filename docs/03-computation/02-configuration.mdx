...
For the PCE to give you recommended actions adapted to your specific architecture and needs, you first need to configure it via its [**configuration API**](https://stage.computing.blindnet.io/swagger/#/Configuration).
