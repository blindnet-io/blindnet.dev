...
- a provenance term, with an associated predefined [set of terms](https://github.com/blindnet-io/product-management/blob/main/refs/schemas/priv/dictionary/provenance/en.provenance.json) uou can extend using [dot notation](https://github.com/blindnet-io/product-management/blob/main/refs/schemas/priv/RFC-PRIV.md#term-dot-notation)
...
<p align="center">
  ...
  <strong>comes from / has been</strong>{' '}
  <em>
