...
Provenances configuration can be set is the PCE using [PUT /configure/provenances](https://devkit-pce-staging.azurewebsites.net/swagger/#/Configuration/putV0ConfigureProvenances), and is detailed in the related `CreateProvenancePayload` schema.
