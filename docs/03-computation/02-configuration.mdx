...
Legal Bases can be set in the PCE using [PUT /configure/retention-policies](https://devkit-pce-staging.azurewebsites.net/swagger/#/Configuration/putV0ConfigureRetention-policies) as detailed in the related `CreateRetentionPolicy` schema.
