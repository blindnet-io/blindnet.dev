...
<WipWarning repo="https://github.com/blindnet-io/privacy-computation-engine">
  <p>This documentation's writing is still in progress.</p>
  <p>While waiting for it to be completed, we encourage you to refer to the <a href="https://devkit-pce-staging.azurewebsites.net/swagger/">API Swagger Documentation</a>.</p>
</WipWarning>
