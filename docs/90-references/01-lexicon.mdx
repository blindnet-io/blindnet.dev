...
A set of software components for implementing [privacy-enabled connectedness](https://github.com/blindnet-io/product-management/blob/main/refs/notion-of-privacy/notion-of-privacy.md#privacy-enables-connection).
...
Privacy Requests MAY concern any aspect of the [privacy-enabled connectedness](https://github.com/blindnet-io/product-management/blob/main/refs/notion-of-privacy/notion-of-privacy.md#privacy-enables-connection), including transparency, confidentiality and control over data processing.
