...
name | type | required | description
---- | ---- | -------- | -----------
secret | `string` | true | A secret value used to encrypt and decrypt [user’s keys](../../../other/glossary.md#private_key){target=_blank}. Usually, should be derived from user’s password using the [deriveSecrets](../../../guides/managing_users_access.md#splitting_secrets){target=_blank} method.
...
type | description
---- | -----------
AuthenticationError | [Token](../../../other/glossary.md#authentication_token){target=_blank} has expired or is invalid. [Generate a new token](../../../guides/managing_users_access.md#creating_user_tokens){target=_blank} and call [refreshToken](#refreshing_the_session).
BlindnetServiceError | Error on blindnet server.
PasswordError | A bad [secret](../../../other/glossary.md#secret_value){target=_blank} has been provided. Could not decrypt the [user’s keys](../../../other/glossary.md#private_key){target=_blank}.
...
## Logging-out
After the user is logged out of your app, following method should be called to clean the [user’s keys](../../../other/glossary.md#private_key){target=_blank} from the browser
...
name | type | required | description
---- | ---- | -------- | -----------
newSecret | `string` | true | A new secret used to encrypt [user’s keys](../../../other/glossary.md#private_key){target=_blank}.
oldSecret | `string` | false | Current secret used to encrypt [user’s keys](../../../other/glossary.md#private_key){target=_blank}. If the user is currently not [logged into](../../../guides/managing_users_access.md#registering_and_logging_users_in_blindnet){target=_blank} blindnet, `oldSecret` should be provided into the method `changeSecret`.
