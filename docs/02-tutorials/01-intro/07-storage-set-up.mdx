...
Code which relies on the following ORM definition (`example/src/main/java/io/blindnet/storageconnector/example/User.java`):
...
Meaning the `StorageConnector` in the above example will only
