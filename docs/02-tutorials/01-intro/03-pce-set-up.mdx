...
Click on the **General information** item and fill out the form. Save the changes.  

### Configure Request resolution strategy

:::info
Most of the request types can be automated using the blindnet devkit. We will make the devkit respond to `TRANSPARENCY` requests automatically.  
:::
