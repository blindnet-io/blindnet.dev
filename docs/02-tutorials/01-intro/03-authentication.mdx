...
Now that we have exposed a [Privacy Request Capture Interface](https://github.com/blindnet-io/devkit-quickstart/blob/main/tutorials/intro/web/expose-request-interface.html)
