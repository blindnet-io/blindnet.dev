---
sidebar_position: 2
title: 2. Configure Privacy Computation Engine
...
We'll set up the Privacy Computation Engine in two steps:
...
```
Insturctions on how to go beyond the "quick start" intro and set up full details for your organisation, are given [here](../../computation/configuration#general-information)
### Configure a legal base

Legal bases are one of the key concepts of the blindnet devkit. 
They are explained in more details in [the documentation](../../computation/configuration#legal-bases). 
For the purposes of this "quick start" introduction, we will define only one legal base - a consent. 
We will configure a consent legal base that covers using a user's email address for advertising purposes. Later in the tutorial, a user will "give" their consent.
