...
Now, let's test it out! Open the [static page](https://github.com/blindnet-io/devkit-quickstart/blob/main/tutorials/intro/web/add-authentication.html) we just created and ensure the PCE we set up is still running.
...
In this tutorial we disable the Privacy Portal until a token is passed to illustrate the use of the [Privacy Portal](/docs/interfaces/privacy-portal) in combination with the PCE. It is also possible to use the Privacy Portal by itself, as we do in [part one](./privacy-portal-set-up). 
