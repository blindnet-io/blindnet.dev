...
For this section of the tutorial, we will start with the simple static frontend available [here](QUICKSTART REPO LINK) and modify the `<body>` content.
...
The HTML file with our changes thus fair is available [here](QUICKSTART REPO LINK)
