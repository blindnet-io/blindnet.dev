...
An additional Privacy Component for the Web, called the "Bridge", is here to help you handle these requests.
...
To add the Bridge Web Component to your project, simply follow the same steps as for the Privacy Portal one, but with the `@blindnet/dci` npm package, and `<bldn-bridge>` HTML custom element.
