...
To authenticate to the blindnet encryption engine, your application needs an [application id](/docs/references/glossary#application-id) and [application key](/docs/references/glossary#application-key).
