...
> **The promise: blindnet devkit is the simplest solution for implementing [privacy-enabled connectedness](./notions-of-privacy#privacy-enabled-connectedness). It enables confidentiality, control and compliance with regulation**
>
...
**[DPOs](./lexicon#dpo)** are a special type of Users that use the System to respond to Privacy Requests. They MAY have limited access to the data itself (and in some case MUST NOT be able to see the data) but leverage the System as a proof of having acted legally and respected data subjects’ rights.
