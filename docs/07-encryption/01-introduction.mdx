...
The blindnet Encryption Engine gives all developers the hability to protect users’ data (e.g., files, images, documents) in an easy and intuitive way.
...
The blindnet Encryption Engine is compatible with all available user authentication systems. The user experience does not change when you integrate the blindnet devkit.
