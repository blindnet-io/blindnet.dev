...
**explanation**: [Token](/docs/references/glossary#authentication-token) is invalid or has expired.  
**api methods**: All SDK methods except [init](./installation#initialization), [deriveSecrets](./managing_users_access#splitting-secrets) and [disconnect](./managing_users_access#logging-out-users)  
**solution**: [Generate a new token](./managing_users_access#creating-user-tokens) on the backend and pass it to the console.
...
**api methods**: [decrypt](./decrypt#decrypt), [decryptValues](./decrypt#decryptvalues), [changeSecret](./managing_users_access#changing-secrets), [giveAccess](./managing_users_access#giving-access-to-other-users)  
**solution**: Call [connect](./managing_users_access#connecting-users-with-blindnet) method to get the keys.
...
**api methods**: [connect](./managing_users_access#connecting-users-with-blindnet)
...
**api methods**: [decrypt](./decrypt#decrypt), [decryptValues](./decrypt#decryptvalues)
...
**api methods**: all SDK methods except init, [deriveSecrets](./managing_users_access#splitting-secrets) and [disconnect](./managing_users_access#logging-out-users).  
...
**api methods**: [encrypt](./encrypt#encrypt), [encryptValues](./encrypt#encryptvalues)  
...
**api methods**: [giveAccess](./managing_users_access#giving-access-to-other-users), [changeSecret](./managing_users_access#changing-secrets)  
...
**explanation**: Internet explorer has very limited support for web crypto API so the blindnet encryption engine doesn’t work on it.  
