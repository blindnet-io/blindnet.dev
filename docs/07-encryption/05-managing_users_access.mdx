...
## Changing secrets
Since user's keys are encrypted with the [user's secret](/docs/references/glossary#secret-value), changing the secret means the keys must be re-encrypted with the new secret value.  
