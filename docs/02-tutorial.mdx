...
To make things easier for this tutorial, we have already pre-configured a dedicated custom instance for you to play with:
...
See [Using Web Components](/docs/interfaces/using-web-components) for more information on how to integrate Web Components in your existing project.
...
This simple static demo can be tested live on [blindnet-io.github.io](https://blindnet-io.github.io/privacy-components-web/demos/devkit-simple-tutorial/demos/static/).

Code can be found in the [privacy-components-web repository](ttps://github.com/blindnet-io/privacy-components-web/tree/main/demos/static).
...
Here, you can see your users can directly choose from a wide range of privacy request types.
...
In accordance with GDPR and other legislations, these are only requests. **You** determine how those are handled and answered, manually or automatically.
