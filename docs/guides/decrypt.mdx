...
1. The [encrypted symmetric key](../extra/glossary#encrypted-data-key) of the user for the provided encrypted data is obtained from blindnet 
...
[Metadata](../extra/glossary#metadata), besides the object fields provided in the [encrypt](./encrypt#encrypt) method, will contain additional information on data format so it can be treated accordingly.
