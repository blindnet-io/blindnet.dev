...
The figure below shows different components of blindnet devkit and privacy stack:
...
- The browser will use blindnet devkit to encrypt the data
...
- The browser on Alice's device will use blindnet devkit to decrypt the data
...
In Step 4. (The browser on Alices's device will use blindnet api to decrypt the data), blindnet devkit performs the following steps:
