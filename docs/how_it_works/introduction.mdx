...
| ----------- | ----------- | ----------- 
| Web app only | web-to-web | [Solution 1: encryption only](./how_it_works#blindnet-in-web-applications)
| Mixed: web and standalone apps (mobile/desktop) | web-to-web, web-to-standalone, standalone-to-standalone | [Solution 1: encryption only](./how_it_works#blindnet-in-web-applications)
| Standalone app only (mobile/desktop) | standalone-to-standalone | [Solution 2: encryption and transfers](./how_it_works#blindnet-in-mobiledesktop-only-applications) (coming soon)
